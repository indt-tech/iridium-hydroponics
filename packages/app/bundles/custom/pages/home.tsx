...
const Home = (props) => {
  ...
  const logoUrl = "/media/logoFull-" + themeName + ".png"
      ...
      <DefaultLayout title="Iridium Hydroponics " description="Made with love from Barcelona" footer={false} tintSwitcher={false}>
        <Section>
          <YStack py="$20" ai="center">
            <img src={logoUrl} width="650" />
            <Paragraph color={"$color7"} scale={2} fontWeight="400">
        ...
        <Section>
          <YStack maw="950px" als="center">
            <Grid gap="25" itemMinWidth="280">
              ...
              <img src="/media/electronics.jpg" width="1000" />
            </Grid>
          </YStack>
        </Section>
        ...
        <YStack ai={'center'}>
          <Link href="http://localhost:8080/documentation">
            <ButtonSimple margin="$13" size="$3" padding="$4" theme="green" alignSelf="center">
              go to documentation
            </ButtonSimple>
          </Link>
        </YStack>

        <Section pt="$15" borderColor="$color3">
          <SpotLight />
          <Theme reset={true}>
                ...
                <YStack w="50%" $sm={{ w: "100%" }}>
                  <YStack gap="$4">
                    <FeatureItem margin="$4" label="We offer">
                      <Text fontWeight="400">The aim is to</Text>
                      <Text fontWeight="800">maximize</Text>
                      <Text fontWeight="400">the use of water and nutrients while increasing crop production per square meter compared to traditional agriculture. This is achieved by</Text>
                      <Text fontWeight="800">automating monitoring</Text>
                      <Text fontWeight="400">and maintenance processes to optimize plant growth. Is also easy to operate, even for users with no previous experience in hydroponics.</Text>
                    </FeatureItem>
  ...
  component: (props) =>
    useEditor(
      () => Home(props),
      {
        ...
        editors: [],//["admin"],
        context: {
          logoUrl: "/media/logoFull-light.png"
        },
        components: {
